	...
	<nav class ="navbar navbar-default navbar-fixed-top">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				...
				<li><a href="#introducePSK">Who is PSK</a></li>
          ...
          <div class="col-md-7">
            <h2 class="featurette-heading">
				...
				<p class="lead">
					...
					java, HTML, Sevlet, JSP, JS, CSS의 구현과정, MVC의 model-1, model-2의 구조를 익혔습니다.<br>
        ...
        <div class="row featurette">
          <div class="col-md-7 col-md-push-5">
            <h2 class="featurette-heading">
            	...
            	<p class="lead">
					군 전역 후 학업에 열중 해 보자는 목표에 2011학년도 성적 2위 장학금을 받은 적이 있습니다. 자격증으로 정보처리기사, 컴퓨터활용능력 1급을 취득하며 한 발짝 한 발짝 나아갔습니다.<br>
					인턴으로 있었던 작은 스타트업 회사에서 만든 앱 '요가코치'는 제 2회 대한민국 앱 창작대회에서 동상을 수상, 당시 앱스토어 헬스분야 1위를 하기도 했습니다.<br>
					이렇게 정성을 다해 나간다면 좋은 결과를 얻는 다는 것을 경험하였습니다. <br>
					작은 취미로 시작한 쇼콜라티에는 대한민국 최고자격인 디렉터까지 취득하여 높은 수준의 수제 초콜릿을 제작, 판매, 강의도 하여 쇼콜라티에를 배출하기도 했습니다.<br>
        ...
        <div class="row featurette">
          <div class="col-md-7">
            <h2 class="featurette-heading">
            	...
            	<p class="lead">
					초콜릿과 일본어를 공부하고 싶어 찾아간 일본. 이상과 달리 현실은 가혹했습니다. 하지만 저는 포기하지 않았습니다. 적지 않은 나이에 새로운 것을 배울 수 있다는 것에 감사했습니다.<br>
            	 	일본에서 가장 힘들었었던 일은 야마토 운수였습니다.하지만 가장 즐겁기도 했습니다. 미숙한 일본어와 고된 일이 힘들었지만, 열심히 임하는 자세에 함께 해주는 동료들이 있어 점점 익숙해 졌습니다.
            	 	손님들도 걱정에서 믿음으로 모습이 바뀌어 뿌듯했습니다.<br>
          ...
          <div class="col-md-7">
            <h2 class="featurette-heading">
				...
				<p class="lead">
					...
					java, HTML, Sevlet, JSP, JS, CSSの具現過程, MVC model-1, model-2の 仕組みを勉強しました。<br>
          ...
          <div class="col-md-7 col-md-push-5">
            <h2 class="featurette-heading">
            	...
            	<p class="lead">
					...
					資格証で情報処理技師,コンピューター活用能力1級を取得しながら,一歩一歩進んでいきました。<br>
					インターンだった小さなスタートアップ会社で作ったアプリ"ヨガコーチ"は第2回大韓民国アプリ創作大会で銅賞を受賞し, 当時アプリストアヘルス分野1位をしたこともあります。 
					このように精魂込めて出るなら良い結果を得ることを経験しました。<br>
					小さい趣味で始まった"ショコラティエ"は,韓国の最高資格であるディレクターまで取得し,高いレベルの手作りチョコレートを制作,販売,講義を行い,ショコラティエを輩出しました。<br>
            ...
            <h2 class="featurette-heading">
            	...
            	<p class="lead">
            		チョコレートと日本語を学びたくて訪ねた日本。以上と違って現実は厳しかったです。             		
 					しかし,私はあきらめませんでした。 少なくない歳に新しいことを学ぶことができるということに感謝しました。<br>
            	 	日本で一番大変だった事はヤマト運輸でした。でも一番楽しかったりもしました。下手な日本語とつらいことが大変でしたが、親切な仲間と一緒にしていたら大変なことも楽しかったです。
            	 	お客さんも心配から信じてくれる姿に変わって行ってやりがいもありました。<br>
